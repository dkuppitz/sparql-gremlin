image::https://raw.githubusercontent.com/dkuppitz/sparql-gremlin/master/static/sparql-gremlin-logo.png[SPARQL-Gremlin]
...
To use Gremlin-SPARQL as a Gremlin shell plugin, run the following commands:
